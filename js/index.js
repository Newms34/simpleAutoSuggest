const app = angular
    ...
    .controller("myCont", $scope => {
        ...
        $scope.myFilter = (a, f) => {
            ...
            return a.filter(q => q.toLowerCase().includes(f.toLowerCase()));
        };
    })
    .directive("simpleAutoSuggest", function ($sce) {
        return {
            ...
            <div style='width:{{inpBoxDims.width}}px; min-height:100px;' ng-show='hasFocus && ((filteredItems && filteredItems.length)||showNFBox)'>
                    <div ng-repeat='si in filteredItems' class='simple-auto-suggest-suggestion' ng-click='pickItem(si);$event.stopPropagation();' ng-bind-html='hilite(si)'></div>
                    <div ng-if='showNFBox'>
            ...
            link: function (scope, element, attributes) {
                console.log("ATTRIBUTES", attributes, "ELEMENT", element);
